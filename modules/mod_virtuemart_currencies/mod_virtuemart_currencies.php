...
<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
	...
	echo $ps_html->selectList( 'product_currency', $GLOBALS['product_currency'], $currencies, 1, '', 'onchange="submitForm()" style="width:130px;"' );
	?>
	<input type="hidden" name="do_coupon" value="yes" />
    <input class="button" style="display:none;" id="currencyselector" type="submit" name="submit" value="<?php echo 'Change Currency' ?>" />
</form>
</div>
<script>
function submitForm()
	{
		document.getElementById('currencyselector').click();
	}
</script>