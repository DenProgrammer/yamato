var Base64 = {
	...
	jQuery('document').ready(function($){
		...
		$('div.curl img').each(function(){return;
		...
		$('div.curl a').click(function(){return true;
			if (p == 1) document.location = 'index.php?option=com_auk&p='+Base64.encode('http://was.autoserver.co.jp/asnete/' + auk + '/main'+$(this).attr('href'))+'&step='+parseInt(step+1);
