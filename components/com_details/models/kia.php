 ...
 * @since		1.6
 */
class DetailsModelKia extends JModel
{
	public function getData()
		{
			...
			switch($step)
				{
					case 1: $url = "http://japancars.ru/index.php?route=catalog/kia"; break;
					case 2: 
						{
							$url = "http://japancars.ru/index.php?route=catalog/kia/variants&area=$area"; 
							if ($cat) $url .= "&cat=$cat";
							if ($clf) $url .= "&clf=$clf";
							break;
						}
					case 3: $url = "http://japancars.ru/index.php?route=catalog/kia&area=$area&cat=$cat&clf=$clf"; break;
					case 4: $url = "http://japancars.ru/index.php?route=catalog/kia&area=$area&cat=$cat&clf=$clf&grp_id=$grp_id"; break;
					case 5: $url = "http://japancars.ru/index.php?route=catalog/kia&area=$area&cat=$cat&clf=$clf&grp_id=$grp_id&blk_id=$blk_id"; break;
				}
