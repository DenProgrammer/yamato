...
<div class="print-content" >
    ...
    <hr />
    <div class="imagelist" >
        <img class="mainimage" src="<?php echo $this->product->product_full_image ?>">
        <?php
        $i = 0;
                ...
                <td>
                    <table class="avtoparams" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td>Год выпуска</td>
                            <td><?php
                                if ($this->product->year > 1900) {
                                    echo $this->product->year;
                                } else {
                                    echo '-';
                                }
                                ?></td>
                        ...
                        <tr>
                            <td>Обьем</td>
                            <td><?php
                                if ($this->product->EngineSize) {
                                    echo $this->product->EngineSize;
                                } else {
                                    echo '-';
                                }
                                ?></td>
                        ...
                        <tr>
                            <td>КПП</td>
                            <td><?php
                                if ($this->product->TipKPP) {
                                    echo $this->product->TipKPP;
                                } else {
                                    echo '-';
                                }
                                ?></td>
                        ...
                        <tr>
                            <td>Пробег</td>
                            <td><?php
                                if ($this->product->Probeg) {
                                    echo $this->product->Probeg;
                                } else {
                                    echo '-';
                                }
                                ?></td>
                        ...
                        <tr>
                            <td>Кузов</td>
                            <td><?php
                                if ($this->product->TipKuzova) {
                                    echo $this->product->TipKuzova;
                                } else {
                                    echo '-';
                                }
                                ?></td>
                        ...
                        <tr>
                            <td>Тип топлива</td>
                            <td><?php
                                if ($this->product->TipTopliva) {
                                    echo $this->product->TipTopliva;
                                } else {
                                    echo '-';
                                }F
                                ?></td>
