...
?>
  <h3><?php echo $VM_LANG->_('PHPSHOP_ACC_CUSTOMER_ACCOUNT') ?></h3>
...
<?php if( $my->id > 0)  { ?>
    <tr>
      ...
      <strong><a href="<?php $sess->purl(SECUREURL . "index.php?page=account.billing") ?>">
          <?php 
          echo "<img src=\"".VM_THEMEURL."images/identity.png\" align=\"left\" height=\"48\" width=\"48\" border=\"0\" alt=\"".$VM_LANG->_('PHPSHOP_ACCOUNT_TITLE')."\" hspace=\"10\" />&nbsp;";
