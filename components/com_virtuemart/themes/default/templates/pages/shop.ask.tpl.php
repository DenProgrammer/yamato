...
if ($prod->product_type == 'automobil') {
	$product_name = '<span class="marka">'.JString::strtolower($prod->marka).'</span>&nbsp;<span class="model">'.$prod->model.'</span>&nbsp;'.$prod->year.' г.';
} else {
...
if ( $set == 0 ) { // This is the enquiry form!
	...
	<br /><br />
	<div>Ваш вопрос по <?php echo $product_name; ?></div>
	<form style="text-align:left;width:510px;margin:0 auto;" action="<?php echo $mm_action_url ?>index.php" method="post" name="emailForm" id="emailForm">
