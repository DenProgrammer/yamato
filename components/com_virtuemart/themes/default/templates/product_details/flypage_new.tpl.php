    ...
    <tbody>
        <tr>
            <td valign="top" width="290">
                <div class="imagecont">
                    <a rel="lightbox[product<?php echo $prod->product_id ?>]" title="<?php echo $prod->product_name ?>" href="<?php echo $prod->product_full_image ?>">
                        <img width="262" border="0" alt="<?php echo $prod->product_name ?>" title="<?php echo $prod->product_name ?>" src="<?php echo $prod->product_thumb_image ?>">
                    </a>
