...
/**
*
* @version $Id: affiliate.affiliate_add.php 1095 2007-12-19 20:19:16Z soeren_nb $
* @package VirtueMart
* @subpackage html
...
<h2><?php echo $VM_LANG->_('PHPSHOP_SHOPPER_FORM_LBL') ?></h2>
<?php 
    ...
    <tr> 
      <td colspan="2" valign="top"> 
        <table width="100%" border="0" cellspacing="0" cellpadding="2">
          <tr> 
            <td width="24%" nowrap align="right" ><?php echo $VM_LANG->_('PHPSHOP_SHOPPER_FORM_FIRST_NAME') ?>:</td>
            <td width="76%" > 
              <input type="text" name="first_name" size="18" value="<?php $db->sp("first_name") ?>">
            </td>
          </tr>
          <tr> 
            <td width="24%" nowrap align="right" ><?php echo $VM_LANG->_('PHPSHOP_SHOPPER_FORM_LAST_NAME') ?>:</td>
            <td width="76%" > 
              <input type="text" name="last_name" size="18" value="<?php $db->sp("last_name") ?>">
            </td>
          </tr>
          <tr> 
            <td width="24%" nowrap align="right" ><?php echo $VM_LANG->_('PHPSHOP_SHOPPER_FORM_MIDDLE_NAME') ?>:</td>
            <td width="76%" > 
              <input type="text" name="middle_name" size="16" value="<?php $db->sp("middle_name") ?>">
            </td>
          </tr>
          <tr> 
            <td width="24%" nowrap align="right" ><?php echo $VM_LANG->_('PHPSHOP_SHOPPER_FORM_TITLE') ?>:</td>
            <td width="76%" > <?php $ps_html->list_user_title($db->sf("title")); ?></td>
          </tr>
          <tr> 
            <td width="24%" nowrap align="right" ><?php echo $VM_LANG->_('PHPSHOP_SHOPPER_FORM_USERNAME') ?>:</td>
            <td width="76%" > 
              <input type="text" name="username" size="16" value="<?php $db->sp("username") ?>">
            </td> 
          </tr>
          <tr> 
            <td width="24%" nowrap align="right" > <?php echo $VM_LANG->_('PHPSHOP_SHOPPER_FORM_GROUP') ?>:</td>
            <td width="76%" ><?php
          ...
          <tr> 
            <td colspan="2" nowrap><b><?php echo $VM_LANG->_('PHPSHOP_SHOPPER_FORM_BILLTO_LBL') ?></b></td>
          </tr>
          <tr> 
            <td width="24%" nowrap align="right" ><?php echo $VM_LANG->_('PHPSHOP_SHOPPER_FORM_COMPANY_NAME') ?>:</td>
            <td width="76%" > 
              <input type="text" name="company" size="24" value="<?php $db->sp("company") ?>">
            </td>
          </tr>
          <tr> 
            <td width="24%" nowrap align="right" ><?php echo $VM_LANG->_('PHPSHOP_SHOPPER_FORM_STATE') ?>:</td>
            <td width="76%" > 
              <input type="text" name="state" size="3" value="<?php $db->sp("state") ?>">
            </td>
          </tr>
          <tr> 
            <td width="24%" nowrap align="right" ><?php echo $VM_LANG->_('PHPSHOP_SHOPPER_FORM_ZIP') ?>:</td>
            <td width="76%" > 
              <input type="text" name="zip" size="10" value="<?php $db->sp("zip") ?>">
            </td>
          </tr>
          <tr> 
            <td width="24%" nowrap align="right" ><?php echo $VM_LANG->_('PHPSHOP_SHOPPER_FORM_COUNTRY') ?>:</td>
            <td width="76%" > 
              <input type="text" name="country" size="16" value="<?php $db->sp("country") ?>">
            </td>
          </tr>
          <tr> 
            <td width="24%" nowrap align="right" > <?php echo $VM_LANG->_('PHPSHOP_SHOPPER_FORM_PHONE') ?>:</td>
            <td width="76%" > 
              <input type="text" name="phone_1" size="12" value="<?php $db->sp("phone_1") ?>">
            </td>
          </tr>
          <tr> 
            <td width="24%" nowrap align="right" ><?php echo $VM_LANG->_('PHPSHOP_SHOPPER_FORM_EMAIL') ?>:</td>
            <td width="76%" > 
