...
/**
*
* @version $Id: checkout.wannafind_cc_form.php 1122 2008-01-07 14:52:31Z thepisu $
* @package VirtueMart
* @subpackage html
  ...
  if ($db->next_record()) {
    ...
    function check_pbscc_form() {
      ...
      return true;
        ...
        &nbsp;<form method="post" action="https://betaling.wannafind.dk/auth.php" name="checkout_pbscc_payment">
	...
	<input type="hidden" name="accepturl" value="<?php $sess->purl( SECUREURL ."index.php?page=checkout.wannafind_result&accept=1&sessionid=".$sessionid) ?>" />
	<input type="hidden" name="declineurl" value="<?php $sess->purl( SECUREURL ."index.php?page=checkout.wannafind_result&accept=0&sessionid=".$sessionid) ?>" />
