...
*
* @version $Id: checkout.wannafind_result.php 1122 2008-01-07 14:52:31Z thepisu $
* @package VirtueMart
* @subpackage html
    ...
    ?> 
        ...
        <?php
            switch (urldecode($_REQUEST['errorcode'])) {
                case 1: echo $VM_LANG->_('VM_CHECKOUT_WF_ERROR_1'); break; 
                case 2: echo $VM_LANG->_('VM_CHECKOUT_WF_ERROR_2'); break; 
                case 3: echo $VM_LANG->_('VM_CHECKOUT_WF_ERROR_3'); break; 
                case 4: echo $VM_LANG->_('VM_CHECKOUT_WF_ERROR_4'); break; 
                case 5: echo $VM_LANG->_('VM_CHECKOUT_WF_ERROR_5'); break; 
                case 6: echo $VM_LANG->_('VM_CHECKOUT_WF_ERROR_6'); break; 
                case 7: echo $VM_LANG->_('VM_CHECKOUT_WF_ERROR_7'); break; 
                case 8: echo $VM_LANG->_('VM_CHECKOUT_WF_ERROR_8'); break; 
                case 9: echo $VM_LANG->_('VM_CHECKOUT_WF_ERROR_9'); break; 
                case 10: echo $VM_LANG->_('VM_CHECKOUT_WF_ERROR_10'); break; 
                case 11: echo $VM_LANG->_('VM_CHECKOUT_WF_ERROR_11'); break; 
                case 12: echo $VM_LANG->_('VM_CHECKOUT_WF_ERROR_12'); break; 
                case 13: echo $VM_LANG->_('VM_CHECKOUT_WF_ERROR_13'); break;
                default: echo $VM_LANG->_('VM_CHECKOUT_WF_ERROR_DEFAULT');
            }
        }
        ?>
        <br />
