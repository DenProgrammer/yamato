...
if ($_GET['cm']) $q .= ' AND `#__{vm}_product`.`marka`=\''.$_GET['cm'].'\'';
if ($_GET['marka']) $q .= ' AND `#__{vm}_product`.`marka`=\''.$_GET['marka'].'\'';
if ($_GET['model']) 
	{
...
if ($_GET['rul']) 
	{
		if ($_GET['rul']=='rul_left') $q .= ' AND `#__{vm}_product`.`RaspolojenieRulya`=\'ЛевыйРуль\'';
		if ($_GET['rul']=='rul_right') $q .= ' AND `#__{vm}_product`.`RaspolojenieRulya`=\'ПравыйРуль\'';
	}
if ($_GET['find_text'])
	{
