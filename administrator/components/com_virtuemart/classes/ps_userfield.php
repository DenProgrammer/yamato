...
/**
*
* @version $Id: ps_userfield.php 2659 2010-11-21 11:25:33Z zanardi $
* @package VirtueMart
* @subpackage classes
...
class vm_ps_userfield extends vmAbstractObject {
	...
	function listUserFields( $rowFields, $skipFields=array(), $db = null, $startForm = true ) {
		...
		$delimiter = 0;
	   	...
	   	foreach( $rowFields as $field) {
			echo '<div class="item item'.$field->type.'">';
			...
			if( $key[0] == '_') {
	   		...
	   		if( $field->type == 'delimiter') {
					echo '<div class="delimeter" ></div></div>';
	   			if( $delimiter > 0) {
	   				//echo "</fieldset>\n";
	   			}
...
if (defined('VM_ALLOW_EXTENDED_CLASSES') && defined('VM_THEMEPATH') && VM_ALLOW_EXTENDED_CLASSES && file_exists(VM_THEMEPATH.'user_class/'.basename(__FILE__))) {
	...
	class ps_userfield extends vm_ps_userfield {}
}
?>
