    ...
    */
	...
	function list_order($order_status='A', $secure=0 ) {
		...
		while ($db->next_record()) {
			...
			$order_status = trim(ps_order_status::getOrderStatusName($db->f("order_status")));
			...
			$tmp_cell = "<strong>".$VM_LANG->_('PHPSHOP_ORDER_PRINT_PO_STATUS').":</strong> ".JText::_("$order_status");
