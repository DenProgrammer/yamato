...
$langvars = array (
	...
	'PHPSHOP_WAITING_LIST_MESSAGE' => 'К сожалению выбранное Вами количество товара отсутствует на складе. Пожалуйста, оставьте свой e-mail, чтобы мы известили Вас, когда этот товар снова появится на складе. 
