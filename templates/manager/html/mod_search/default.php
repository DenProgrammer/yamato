...
?>
<div class="search">
<form action="index.php" id="searchform" method="post" class="search<?php echo $params->get('moduleclass_sfx'); ?>">
	<?php
		    $output = '<input 
							name="searchword" 
						...
						/>
						&nbsp;<img onclick="jQuery(\'#searchform\').submit();" style="cursor:pointer;vertical-align:bottom;" src="images/search-button.png"/>';
	...
	<input type="hidden" name="Itemid" value="<?php echo 2;//$mitemid; ?>" />
</form>
</div>
